        ...
        <div className="p-5">
          ...
          <div className="flex justify-between items-start mb-4">
            <div className="flex-1 min-w-0 pr-2">
              <h3 className="text-gray-900 leading-tight mb-1 truncate" style={{ fontSize: '1rem', fontWeight: 600 }}>{lot.name}</h3>
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-1.5">
              {lot.permitTypes.map((permitType) => (
                <span
                  key={permitType}
                  className={`${PERMIT_INFO[permitType].color} text-white text-xs px-2.5 py-0.5 rounded-full font-medium`}
                >
                  {permitType}
                </span>
              ))}
