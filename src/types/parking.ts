export type PermitType = 'S' | 'R' | 'Y' | 'E' | 'GZ' | 'D' | 'AG33' | 'HE' | 'AG42' | 'GZ01' | 'GZ02' | 'GZ08' | 'GZ09' | 'GZ33' | 'GZ36' | 'GZ42' | 'WB';
...
export const PERMIT_INFO: Record<PermitType, { name: string; description: string; color: string; bgLight: string; textColor: string }> = {
  ...
  // Moffitt Cancer Center Employee Permits
  'AG33': {
