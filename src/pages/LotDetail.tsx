                ...
                <div className="grid grid-cols-3 gap-6 mb-6">
                  <div className="text-center">
                    <div className={`text-4xl font-bold ${
                      ...
                      status === 'moderate' ? 'text-orange-600' : 'text-red-600'
                    }`}>{lot.availableSpaces}</div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {routesToday.map((route) => {
                          ...
                          return (
                            <div
                              key={route}
                              className={`${routeColors.bg} ${routeColors.text} px-3 py-1.5 rounded-lg text-sm font-medium border-2 ${routeColors.border} inline-flex items-center gap-1.5`}
                            >
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
              ...
              <div className="p-5 space-y-2">
                {lot.permitTypes.map((permitType) => (
                  <div key={permitType} className="flex items-center gap-3">
                    <span className={`${PERMIT_INFO[permitType].color} text-white text-xs px-2.5 py-1 rounded-full font-medium min-w-[44px] text-center`}>
                      {permitType}
                    </span>
                    <span className="text-gray-700 text-sm">{PERMIT_INFO[permitType].name}</span>
                  </div>
                ))}
              </div>
            </div>
